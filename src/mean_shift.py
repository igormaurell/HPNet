...
class MeanShift:
    ...
    def guard_mean_shift(self, embedding, quantile, iterations, kernel_type="gaussian", num_samples=5000, bw=None):
        """
        ...
        while True:
            _, center, bandwidth, cluster_ids = self.mean_shift(
                embedding, num_samples, quantile, iterations, kernel_type=kernel_type, bw=bw
            )
